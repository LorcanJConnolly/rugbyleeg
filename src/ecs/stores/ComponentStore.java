...
public abstract class ComponentStore<T extends Component> {
    ...
    protected final Class<T> componentType;  // Store class reference


    protected ComponentStore(int maxEntities, Class<T> componentType){
    ...
    public String toString() {
        return "ComponentStore[" + componentType.getSimpleName() + "]";
    }
