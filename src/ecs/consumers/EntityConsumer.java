 ...
 *
 * <p>The EntityConsumer class provides an interface for a consumer accepting the results of query of type Query1.</p>
 *
 * @param <A> The type of the component being consumed with the entity.
 */
@FunctionalInterface
public interface EntityConsumer<A extends Component> {
     ...
     */
    void accept(int entity, A componentA);
}
