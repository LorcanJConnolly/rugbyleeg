 ...
 *
 * <p>The EntityConsumer class provides an interface for a consumer accepting the results of query of type Query3.</p>
 *
 ...
 * @param <C> The type of the component being consumed with the entity.
 */
@FunctionalInterface
public interface TriEntityConsumer<A, B, C> {
    ...
    /** The consumer method, accepting an entity and its component(s).
     ...
     @param componentC The entity's component.
     */
    void accept(int entity, A componentA, B componentB, C componentC);
}